...
const PreviewSources: React.FC = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await fetch(`http://85.190.242.108:4483/api/Source/Preview?id=${ActionID}`, {
                    headers: {
    ...
    return (
        <DefaultLayout>
            <Breadcrumb pageName="Preview" prevPageName='Sources' prevRoute='/sources' />
