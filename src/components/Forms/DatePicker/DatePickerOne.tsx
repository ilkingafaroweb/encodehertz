...
const DatePickerOne: React.FC<{ labelName: string, disabled: boolean, setSelectedData: any,  value: string, isInvalid?: boolean }> = ({ labelName, disabled, setSelectedData, value, isInvalid }) => {
